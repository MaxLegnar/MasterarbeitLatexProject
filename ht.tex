...
So wirkt sich laut \cite{FlexD3D} die Partikelanzahl weniger stark auf die Performance aus, wie der Partikelradius oder die Anzahl und komplexität der verwendeten Constraints . Befinden sich beispielsweise nur Soft Bodies in einer Szene, muss der Solver deutlich weniger unterschiedliche Constraints lösen, als in einer Szene, in der sich Soft Bodies, Flüssigkeiten und Stoffe befindet.
