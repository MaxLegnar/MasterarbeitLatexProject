...
\newcommand{\hsmatitelde}{Chirurgische Simulatoren in VR mit Position Based Dynamics und Game Engines}

% Titel der Arbeit auf Englisch
\newcommand{\hsmatitelen}{Surgery simulators in VR with Position Based Dynamics and game engines}
