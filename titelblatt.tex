...
\ifthenelse{\equal{\hsmafakultaet}{I}}%
  {\newcommand{\hsmafakultaetlangde}{Institut für Wissenschaftliches Rechnen (IWR)}%
   \newcommand{\hsmafakultaetlangen}{Interdisciplinary Center for Scientific Computing}}{}

\ifthenelse{\equal{\hsmastudiengang}{MEB}}%%%%--------------------------------------------------------------------
  {\newcommand{\hsmastudienganglangde}{Angewandte Informatik \linebreak Fakultät für Mathematik und Informatik}%
...
% Titel der Arbeit_ passe das ales besser nochmal an, ist nicht so ganz mittig irgendwie!!!!!!!!!!
\begin{textblock*}{128mm}(38mm,\seitenanfang + 40mm) % 4,5cm vom linken Rand und 6,0cm vom oberen Rand
...
% Name                                          h
\begin{textblock*}{128mm}(38mm,\seitenanfang + 103mm)%103mm
  \centering\large\sffamily
  \hsmaautor
\end{textblock*}
