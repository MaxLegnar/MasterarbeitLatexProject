...
-> PBD ist toll, weil Partikel wie Punktmassen lässt sich system leicht erweitern (AddForce) und es ist ersteunlich was für komplexe gesamtsysteme auf Grundlage eines solchen einfachen Partikelsystems simuliert werden können.

-> Effiziente Wasser bzw Blut shader für Fluid Partikel werden benötigt

-> hier Bild rein, was mit Framework noch alles tolles gebaut werden konnte....Nicht nur Nadeln können sich in Gewebe verklemmen, auch andere Fremdkörper wie Projektile oder Spreisel.
