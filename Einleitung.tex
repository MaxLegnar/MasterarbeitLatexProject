...
Wichtig: Es ist eine Arbeit, bei der es darum geht, zuerst das 

Potential der position-based dynamics auszuloten und 

(auch sehr wichtig) die Lücken, die da noch sind, zu füllen – das ist ein wichtiger Teil der Arbeit. 

Danach kommt das Anwendungsbeispiel, das so gestrickt ist, dass man paradigmatisch demonstriert, wie das in einer chirurgischen Simulation genutzt werden kann. 

Wichtig: Am Ende soll herauskommen, dass die Möglichkeiten und Grenzen von Flex klar sind und dass die Komponenten, die benötigt werden, um aus dem Potential wirklich etwas Nutzbares zu generieren, auch klar gegliedert und strukturiert genannt sind – das „Handbuch“ würde in den Anhang kommen. Damit ist es möglich, dass Folgeprojekte mit relativ wenig diese Methoden nutzen können, um konkrete Probleme zu lösen – genannt können hier einmal das Projekt Brachysimulator und einmal die Bachelorarbeit zum System on Chip.

\section{Motivation und Problemstellung}


% Motivation für Serous Games:
Die klassische Art, bestimmte Operationen praktisch zu unterrichten, ist die Beobachtung eines erfahrenen Chirurgen über mehrere durchgeführte Operationen. Auch das Trainieren von Operationen mit Tieren, meist Schweine, war früher eine gängige Praxis (REFFF???). Diese Ansätze werden zunehmend durch rechtliche und ethische Bedenken, sowie des Zeitbedarfs und der Kosten behindert \cite{SurgSim}.
