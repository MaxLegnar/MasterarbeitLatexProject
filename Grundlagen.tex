...
Vor allem in der Chirurgie können Serious Games in Form von chirurgischen Simulationen eingesetzt werden, um Personal auf bestimmte Operationen vorzubereiten. Dabei geht es nicht nur darum, Operationsabläufe zu verinnerlichen. Auch die motorischen Fähigkeiten und das motorische Gedächtnis des Spielers wird dabei trainiert. 
...
\bild{SurSim2}{14cm}{Aus \cite{VRmagic}. Links: Die Trainingsstation. Mitte: Position und Orientierung des Werkzeugs wird mittels entsprechender Sensorik erfasst. Rechts: Die Interaktion zwischen dem virtuellen Auge und dem Werkzeug wird in Echtzeit simuliert und fotorealistisch dargestellt.}

Die wichtigste Anforderung von solchen Simulatoren ist die Echtzeitfähigkeit. LESEZEICHEN!!! HIER WEITER!!!...
